...
public class StatistiqueTest {
    private int testId;
    private String formationNom; // Utilisation uniquement du nom de la formation
    ...
    public StatistiqueTest(int testId, String formationNom, double scoreMaximum, double scoreMoyen, int nombreParticipants) {
        this.testId = testId;
