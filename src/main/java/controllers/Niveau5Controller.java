...
public class Niveau5Controller {
    ...
    public void setFormationId(int formationId) {
        ...
        try {
            // Création du niveau 5 avec ordre = 5 explicitement
            this.niveauId = niveauService.creerNiveauSiInexistant(new entities.Niveau(formationId, 5));
            System.out.println("Niveau créé avec ordre 5 pour formation " + formationId);
    ...
    // Passe au niveau suivant (par exemple, ouvrir Test.fxml)
    @FXML
    private void passerTest() {
        // Vous pouvez ajouter ici la logique d'enregistrement ou de vérification du niveau actuel.
        try {
            // Chargement de l'interface du Test
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/Test.fxml"));
            Parent root = loader.load();

            // Transmettre formationId à TestController
            ...
            e.printStackTrace();
            showAlert(Alert.AlertType.ERROR, "Erreur", "Impossible d'ouvrir le Test.");
        }
    }
