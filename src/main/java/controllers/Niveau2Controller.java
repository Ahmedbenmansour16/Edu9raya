...
public class Niveau2Controller {
    ...
    public void setFormationId(int formationId) {
        ...
        try {
            // Création du niveau 2 avec ordre = 2 explicitement
            this.niveauId = niveauService.creerNiveauSiInexistant(new entities.Niveau(formationId, 2));
            System.out.println("Niveau créé avec ordre 2 pour formation " + formationId);
    ...
    // Passe au niveau suivant (par exemple, ouvrir Niveau2.fxml)
    @FXML
    private void passerNiveau3() {
        // Vous pouvez ajouter ici la logique d'enregistrement ou de vérification du niveau actuel.
        try {
            // Chargement de l'interface du Niveau 3
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/Niveau3.fxml"));
            Parent root = loader.load();

            // Transmettre formationId à Niveau3Controller
            Niveau3Controller controller = loader.getController();
            ...
            e.printStackTrace();
            showAlert(Alert.AlertType.ERROR, "Erreur", "Impossible d'ouvrir le Niveau 3.");
        }
    }
