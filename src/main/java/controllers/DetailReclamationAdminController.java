    ...
    public void setReclamation(Reclamation reclamation) {
        ...
        if (reclamation != null) {
            ...
            if (reclamation.getImagePath() != null && !reclamation.getImagePath().isEmpty()) {
                ...
                String fullImagePath = symfonyUploadsPath + reclamation.getImagePath();
                File imageFile = new File(fullImagePath);
                if (imageFile.exists()) {
                    imageView.setImage(new Image(imageFile.toURI().toString()));
                } else {
                    showAlert(Alert.AlertType.WARNING, "Avertissement", "L'image n'a pas été trouvée: " + fullImagePath);
                }
            }
        }
    }
