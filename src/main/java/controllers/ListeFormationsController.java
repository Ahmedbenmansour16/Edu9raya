...
public class ListeFormationsController {
    ...
    private void initialize() {
        ...
        loadFormations();
        updateNotificationCount(); // Ensure notifications are updated on initialize
    }
    ...
    private void openReclamationDetails(Reclamation reclamation) {
        try {
            ...
            // Pass the reclamation to the controller
    ...
    private void updateNotificationCount() {
        try {
            ...
            long count = reclamations.stream()
                    .filter(r -> r.getStatut().equals("en_attente"))
                    .count();
    ...
    private void refreshFormations() {
        ...
        loadNewReclamations(); // Refresh the notification list as well
    }
