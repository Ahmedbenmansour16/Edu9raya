...
public class ListeReclamationsAdminController {
    ...
    private UserService userService = new UserService(); // Ajout pour récupérer les utilisateurs
    ...
    private void initialize() {
        ...
        colEtudiant.setCellValueFactory(cellData -> {
            ...
            try {
                User user = userService.recupererParId(r.getUserId());
                return new ReadOnlyStringWrapper(user != null ? user.getEmail() : "Inconnu");
