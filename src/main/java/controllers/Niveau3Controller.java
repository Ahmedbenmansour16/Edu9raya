...
public class Niveau3Controller {
    ...
    public void setFormationId(int formationId) {
        ...
        try {
            // Création du niveau 3 avec ordre = 3 explicitement
            this.niveauId = niveauService.creerNiveauSiInexistant(new entities.Niveau(formationId, 3));
            System.out.println("Niveau créé avec ordre 3 pour formation " + formationId);
    ...
    // Passe au niveau suivant (par exemple, ouvrir Niveau4.fxml)
    @FXML
    private void passerNiveau4() {
        // Vous pouvez ajouter ici la logique d'enregistrement ou de vérification du niveau actuel.
        try {
            // Chargement de l'interface du Niveau 4
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/Niveau4.fxml"));
            Parent root = loader.load();

            // Transmettre formationId à Niveau4Controller
            Niveau4Controller controller = loader.getController();
            ...
            e.printStackTrace();
            showAlert(Alert.AlertType.ERROR, "Erreur", "Impossible d'ouvrir le Niveau 4.");
        }
    }
